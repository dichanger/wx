...
<html class="manager_page">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="/Public/Admin/css/jquery.ui.datepicker.css" />
		...
		<script src="/Public/Admin/js/jquery.ui.core.js" type="text/javascript" charset="utf-8"></script>
		<script src="/Public/Admin/js/jquery.ui.datepicker.js" type="text/javascript" charset="utf-8"></script>
	...
	<div class="tixian ym" id="tixian_v" style="display: none;">
		...
		<table id="tx_cont">
			...
			<?php if(is_array($dat)): $i = 0; $__LIST__ = $dat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td><input type="checkbox" id="<?php echo ($vo["id"]); ?>" class="qx"></td>
				...
				<td><?php if($vo['type'] == 1 ): ?>打款<?php else: ?>已打款<?php endif; ?></td>			
			</tr><?php endforeach; endif; else: echo "" ;endif; ?>
		</table>
