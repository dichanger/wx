$(function(){
    ...
    var management = {
    	...
    	bind : function() {
    		...
    		$(".add_btn").click(function(){
    			$(".addka_box").show().siblings("div.jiangpin_audit").hide();
    		});
    		$(".addka_box>p,.add_con").click(function(){
    			$(".addka_box").hide().siblings("div.jiangpin_audit").show();
    		});
    	}
    }
    var vipcenter ={
    	...
    	bind : function() {
    		$(".container").css("background-color","#ececec");
    		$(".news_tab_box .weui_tabbar_item").click(function(){
    			$(this).children("p").addClass("cur").parent("a").siblings(".weui_tabbar_item").children("p").removeClass("cur");
    			/*var id = $(this).data("id");
    			if( id == "myzone" ){
    ...
    router.push(management).push(vipcenter)
        .setDefault('/yaoqingma')
        .init();	
